...
public class TangCommentGenerator implements CommentGenerator {
	...
	public void addJavaFileComment(CompilationUnit compilationUnit) {
		...
		compilationUnit.addFileCommentLine("* qccr.com Inc.");
		compilationUnit.addFileCommentLine("* Copyright (c) 2014-2016 All Rights Reserved.");
		compilationUnit.addFileCommentLine("*/");
	}
	...
	public void addFieldComment(Field field, IntrospectedTable introspectedTable,
		...
		sbf.append(getColumnComments(introspectedColumn));
		//sbf.append("-->[").append(introspectedColumn.getActualColumnName()).append("]");
		sbf.append(" */");
		field.addJavaDocLine(sbf.toString()); //$NON-NLS-1$
	}
	 ...
	 * @return
	 */
	private StringBuilder getColumnComments(IntrospectedColumn introspectedColumn){
		StringBuilder sbf=new StringBuilder();
		String remarks = introspectedColumn.getRemarks();
		if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
			String[] remarkLines = remarks.split(System.getProperty("line.separator")); //$NON-NLS-1$
			for (String remarkLine : remarkLines) {
				sbf.append(remarkLine);
			}
		}
		return sbf;
	}
	...
	public void addGetterComment(Method method, IntrospectedTable introspectedTable,
		...
		sb.append(getColumnComments(introspectedColumn));
		method.addJavaDocLine(sb.toString());
	...
	public void addSetterComment(Method method, IntrospectedTable introspectedTable,
		...
		sb.append(getColumnComments(introspectedColumn));
		//sb.append('.').append(parm.getType().getFullyQualifiedName());
		method.addJavaDocLine(sb.toString());
